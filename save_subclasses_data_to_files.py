# -*- coding: utf-8 -*-
"""
Created on Wed Jun 10 07:24:55 2015
...
for cls in classes:
	...
	count_vectorizer = CountVectorizer(decode_error='ignore', max_df=__max_df, stop_words='english', tokenizer=tokenize, ngram_range=n_gram_range)
	...
	text_clf_sgd = SGDClassifier(penalty=__penalty, alpha=__alpha, n_iter=__n_iter)
	...
	macro_fscore = metrics.f1_score(y_test, predicted, average='macro')
	...
	#reporting(count_vectorizer.get_feature_names(), report_dest)
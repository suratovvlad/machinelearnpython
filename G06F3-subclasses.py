# -*- coding: utf-8 -*-
"""
Created on Wed Jun 10 00:19:22 2015
...
global_path += "searchDB_CS\\searchDB_CS\\bin\\Debug\\text-data-G06F3-regen\\"
...
from sklearn.feature_extraction.text import CountVectorizer
count_vectorizer = CountVectorizer(decode_error='ignore', max_df=0.75, stop_words='english', tokenizer=tokenize, ngram_range=(1, 3))
...
pipeline = Pipeline([
	...
	('clf', SGDClassifier(loss='hinge', penalty='elasticnet', alpha=1e-3, n_iter=10, random_state=42)),
])
